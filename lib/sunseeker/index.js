...
class Sunseeker extends EventEmitter {
     ...
     * @param {{setTimeout:Function,clearTimeout:Function,setInterval:Function,clearInterval:Function}} [options.iobTimers]
     */
    constructor(username, password, options = {}) {
        ...
        this.iobTimer = options.iobTimers || {
            setTimeout: (c, t) => setTimeout(c, t),
            clearTimeout: x => clearTimeout(x),
            setInterval: (c, t) => setInterval(c, t),
    ...
    stop() {
        ...
        if (this._mqttRetryTimer) {
            this.iobTimer.clearTimeout(this._mqttRetryTimer);
            this._mqttRetryTimer = null;
        }
        if (this._mqttOldRetryTimer) {
            this.iobTimer.clearTimeout(this._mqttOldRetryTimer);
            this._mqttOldRetryTimer = null;
        }
